...
To install please follow the README inside the repo: https://github.com/felippezacarias/slurm_simulator_scripts.git (disaggregated branch). It has the scripts necessary to set up the configuration files.
