 ...
 */
const char plugin_name[] = "Consumable Resources (CR) Node Selection plugin - hybrid";
const char plugin_type[] = "select/cons_res_hybrid";
const uint32_t plugin_id      = SELECT_PLUGIN_CONS_RES_HYBRID;
