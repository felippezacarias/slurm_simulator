/*****************************************************************************\
 *  select_cons_strawman.c - node selection plugin supporting consumable
 *  resources policies.
 *****************************************************************************\
 *
...
#include "job_test.h"
#include "select_cons_strawman.h"
				...
				bool prefer_alloc_nodes)
{
	...
	debug5("SDDEBUG: %s count memory_pool_bitmap %u node_map %u",__func__,bit_set_count(memory_pool_map),bit_set_count(node_map));
